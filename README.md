...
<img src="media/nami_equation.png" alt="nami eq" width="100%">


And here are the stats:

<img src="media/Nami_activation_ResNet18.png" alt="Nami" width="100%">
- **Nami**: 
    Validation Accuracy `94.81`,
    Training Loss `0.0015`,
    Validation Loss `0.1963`

<img src="media/Mish_Resnet18.png" alt="Mish" width="100%">
- **Mish**:
    Validation Accuracy `94.09`,
    Training Loss `0.0032`,
    Validation Loss `0.2424`

<img src="media/Swish_resnet18.png" alt="Swish" width="100%">
- **Swish/SiLU**:
